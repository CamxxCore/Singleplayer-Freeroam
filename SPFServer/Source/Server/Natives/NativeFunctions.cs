...
namespace SPFServer.Main
{
    public static class NativeFunctions
    {
        ...
        {           
            Server.ActiveSession?.InvokeClientFunction(client, "SET_ENTITY_COORDS_NO_OFFSET",
        ...
        {
            Server.ActiveSession?.InvokeClientFunction(client, "SET_ENTITY_QUATERNION",
                new NativeArg(DataType.LocalHandle),
                rotation.X,
                rotation.Y,
                rotation.Z,
        ...
        {
            Server.ActiveSession?.InvokeClientFunction(client, "REQUEST_ANIM_DICT",
                new NativeArg(DataType.String), animDictionary);

            Server.ActiveSession?.InvokeClientFunction(client, "TASK_PLAY_ANIM", new NativeArg(DataType.LocalHandle), 
                animDictionary, 
                animationName, 
                8f, -8.0f, 
                duration, 
        ...
        {
            Server.ActiveSession?.InvokeClientFunction(client, "SET_ENTITY_HEALTH",
        ...
        {
            Server.ActiveSession?.InvokeClientFunction(client,
        ...
        {
            Server.ActiveSession?.InvokeClientFunction(client, "0xC8CA9670B9D83B3B", hour, minute, second);
