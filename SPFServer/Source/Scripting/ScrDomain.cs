...
namespace SPFServer.Scripting
{
    ...
    public sealed class ScriptDomain : MarshalByRefObject
    {
        ...
        bool LoadScript(string filename)
        {
            ...
            compilerOptions.ReferencedAssemblies.Add(typeof(ScriptBase).Assembly.Location);
...

        {
            ...
            {
                Logger.Log("[ERROR]" + "Failed to list assembly types:" + Environment.NewLine + ex.ToString());
