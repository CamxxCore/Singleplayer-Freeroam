...
namespace SPFLib.Types
{
    public class VehicleState : IEntityState
    {
        ...
        public VehicleState() : this(-1, new Vector3(), new Vector3(), new Quaternion(), 0, 0, 1000, 0, 0, 0, 255, 0)
        { }

        public VehicleState(int id) : this(id, new Vector3(), new Vector3(), new Quaternion(), 0, 0,1000, 0, 0, 0, 255, 0)
        { }
