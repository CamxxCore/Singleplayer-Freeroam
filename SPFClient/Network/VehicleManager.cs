        ...
        private void OnTick(object sender, EventArgs e)
        {
            try
            {
                ...
                while (updateQueue.Count > 0)
                {
                    ...
                    if (vehicleUpdate.Key.ID == PlayerManager.LocalPlayer.Vehicle?.ID)
                    {
                        vehicle = PlayerManager.LocalPlayer.Vehicle;
                    }
                    ...
                    vehicle.HandleStateUpdate(vehicleUpdate.Key, vehicleUpdate.Value);
                }
                ...
                foreach (NetworkVehicle vehicle in activeVehicles)
                {
                    ...
                    if (PlayerManager.LocalPlayer?.Vehicle?.ID == vehicle.ID)
                        continue;
                    vehicle.Update();
                }
            }
