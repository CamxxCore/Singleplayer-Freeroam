...
{                
    ...
    public class UIMenuItem
    {
        ...
        public virtual void Draw()
        {
            ...
            if (Hovered && !Selected)
            {
                _rectangle.Color = Color.FromArgb(itemAlphaFlux < 30 ? itemAlphaFlux += 2 : 30, 255, 255, 255);
                _rectangle.Draw();
            }
            else itemAlphaFlux = 0;
            ...
            if (Selected)
            {
                ...
                {
                    _rectangle.Color = Color.FromArgb(150, Color.Orange);
                    _rectangle.Draw();
                }
            }
