...
namespace SPFClient.Entities
{
    ...
    {
        private static Dictionary<WeaponHash, string> weaponAnimSets = new Dictionary<WeaponHash, string>
        {
        ...
        private Vector3 pAimCoords, pPosition;

        private readonly ulong pAddress;

        private ActiveTask pTask;      
        ...
        public void UpdateLocalAngles(Vector3 pos, Vector3 aimCoords)
        {
            pPosition = pos;
            pAimCoords = aimCoords;
        }
        ...
        public void PlayAnimation(Ped ped, Animation animation, int flags = 1, float speed = -1f)
        {
            Function.Call(Hash.TASK_PLAY_ANIM, ped.Handle,
             animation.Dictionary, animation.Name, 8f, -8.0f, speed, flags, 0, 0, 0, 0);
        }
        ...
        private void ShootWeapon()
        {
            Function.Call(Hash.SET_PED_SHOOTS_AT_COORD, ped.Handle,
               pAimCoords.X, pAimCoords.Y, pAimCoords.Z, true);

            Function.Call(Hash.TASK_SHOOT_AT_COORD, ped.Handle,
                pAimCoords.X, pAimCoords.Y, pAimCoords.Z, -1,
        ...
        private void AimWeapon()
        {
            Function.Call(Hash.TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD, ped.Handle, 
                 ...
                 pAimCoords.X, pAimCoords.Y, pAimCoords.Z, 
        ...
        public void Update()
        {
            ...
            else
            {
                ...
                {
                    PlayAnimation(ped, currentAnimation, 1, ped.IsInWater ? 0.5f : 1f);
                }
        ...
        private class Anims
        {
            ...
            public static readonly Animation SprintWater = new Animation("swimming@swim", "sprint");

            public static readonly Animation RunWater = new Animation("swimming@swim", "run");

            public static readonly Animation WalkWater = new Animation("swimming@swim", "walk");
            ...
            public static readonly Animation Idle = new Animation("move_m@generic", "idle");
        }
    }
}
